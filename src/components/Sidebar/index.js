...
import { faEnvelope, faHome, faUser, faCode, faBars, faClose, faRunning } from '@fortawesome/free-solid-svg-icons'
    ...
    return (
        <div className='nav-bar'>
            ...
            <nav className={showNav ? 'mobile-show' : ''}>
                ...
                {/* <NavLink exact="true" activeclassname="active" className="running-link" to='running' onClick={() => setShowNav(false)}>
